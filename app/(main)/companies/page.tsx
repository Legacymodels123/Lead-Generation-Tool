...
const COLUMNS = [
  ...
  { key: "employees", label: "Employees", width: "90px" },
  { key: "revenue", label: "Revenue", width: "100px" },
  { key: "fitReason", label: "Fit Reason", width: "140px" },
  { key: "website", label: "Website", width: "140px" },
  { key: "contactName", label: "Contact Name", width: "120px" },
  { key: "contactTitle", label: "Contact Title", width: "120px" },
  { key: "linkedinUrl", label: "LinkedIn", width: "140px" },
  { key: "linkedinCompanyUrl", label: "Company LinkedIn", width: "150px" },
  { key: "score", label: "Score", width: "70px" },
  { key: "aiQualificationScore", label: "AI Score", width: "80px" },
            ...
            {filtered.map((lead) => (
              ...
              >
                {COLUMNS.map((col) => {
                  ...
                  } else if (col.key === "website" || col.key === "linkedinUrl" || col.key === "linkedinCompanyUrl") {
                    const url = col.key === "website" && value ? `https://${value}` : value;
                    displayValue = url ? (
                      <a
                        href={url}
                        target="_blank"
                      ...
                      >
                        {col.key === "website" || col.key === "linkedinUrl" ? "🔗" : "Company"}
                      </a>
                    ) : (
                      "-"
                    );
